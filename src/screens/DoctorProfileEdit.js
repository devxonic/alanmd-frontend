...
const handleDocumentPicker = async () => {
  try {
    ...
    console.log('RESPONSE', responce.data?.url);
        setFormData(
       { ...formData,
       image: BASE_URL + responce?.data?.url,}
        )
  ...
  return (
    <SafeAreaView style={styles.container}>
          ...
          <View style={styles.imageContainer}>
                {
                    ...
                    :<Image source={{ uri: 'https://static.vecteezy.com/system/resources/previews/008/957/225/non_2x/female-doctor-avatar-clipart-icon-in-flat-design-vector.jpg' }} style={{ width: 200, height: 200 }} />
                }
                    <View style={styles.uploadBtnContainer}>
                        <TouchableOpacity onPress={handleDocumentPicker} style={styles.uploadBtn} >
                        <Icon
                        name="camera-retro"
                        size={25}
                        color={'white'}
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={handleUpdate} style={[styles.button, { backgroundColor: '#116754' }]} accessibilityLabel="Edit Profile Button">
          <Text style={styles.buttonText}>Update Profile</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=> navigation.goBack()} style={[styles.button, { backgroundColor: '#C54B4B' }]} accessibilityLabel="Logout Button">
