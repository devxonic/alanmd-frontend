    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.profileContainer}>
        ...
        <Text
          style={[
            styles.counterText,
            {fontFamily: Fonts.REGULAR, fontSize: 13, marginTop: 4},
          ]}>
        ...
        <Text
          ...
          {data.location || 'Living Healthy, Living Happy!'}
        </Text>
      </View>
      <View style={styles.counterContainer}>
        <View style={{padding: 5}}>
          <Text
            style={[
              styles.counterItem,
              {borderRightWidth: 1, borderColor: '#116754'},
            ]}>
            130
          </Text>
        ...
        <View style={styles.modalBackground}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity
                style={[styles.ButtonTwo, {backgroundColor: '#E7F0EE'}]}
                onPress={handleCancel}>
                <Text style={[styles.buttonTwoText, {color: 'black'}]}>
                  Cancel
                </Text>
              </TouchableOpacity>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          ...
          <Text
            style={{color: 'white', fontFamily: Fonts.REGULAR, fontSize: 14}}>
            Edit Profile
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
