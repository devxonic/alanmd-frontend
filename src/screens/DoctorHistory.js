...
const History = () => {
  ...
  const renderListItem = ({item}) => (
    <View style={styles.listItem}>
      <View
        ...
        <Image
          source={require('../images/histroy.png')}
      ...
      <View style={{width: '80%'}}>
          ...
          <View style={{flexDirection: 'row', width: '57%', paddingRight: 10}}>
            <TouchableOpacity>
              <Text
                style={[
                  styles.badge,
                  {backgroundColor: '#e3eeeb', color: '#116754', width: 70},
                ]}>
                {item.date}
              </Text>
            </TouchableOpacity>
        ...
        <Text
          ...
          Lorem Ipsum Hospital, Dolor Sit Road, Amet City. Lorem Ipsum Hospital,
          Dolor Sit Road, Amet City.
        </Text>
      </View>
    </View>
  );
  ...
  return (
    <View style={{backgroundColor: '#e3eeeb', flex: 1}}>
      ...
      <SafeAreaView
        style={{backgroundColor: '#e3eeeb', flex: 1, paddingHorizontal: 15}}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              ...
              <Text
                style={[
                  styles.buttonText,
                  selectedCategory === 'All' && styles.activeButtonText,
                ]}>
                All
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.button,
                selectedCategory === 'Pending' && styles.activeButton,
              ]}>
              <Text
                style={[
                  styles.buttonText,
                  selectedCategory === 'Pending' && styles.activeButtonText,
                ]}>
                Pending
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => setSelectedCategory('Not Attended')}
              style={[
                styles.button,
                selectedCategory === 'Delete' && styles.activeButton,
              ]}>
              <Text
                style={[
                  styles.buttonText,
                  selectedCategory === 'Not Attended' &&
